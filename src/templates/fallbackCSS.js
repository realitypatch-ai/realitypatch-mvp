...
.reality-content, .action-content {
    font-family: 'JetBrains Mono', monospace;
    font-size: 13px;
    color: var(--text-primary);
    line-height: 1.6;
...
/* NEW: Creator Footer - Clean, authentic, outside main card */
.creator-footer {
    margin-top: 40px;
    padding: 25px 0;
    text-align: center;
...
@media (max-width: 640px) {
    ...
    .pattern-detected, .reality-check, .specific-action {
        padding: 15px;
    }

// src/templates/fallbackCSS.js - Fixed stats bar styling and spacing
...
/* UNIFIED STATS BAR STYLING - Used by both first-time and main interface */
.stats-bar, .main-stats-bar {
    background: var(--bg-dark);
    padding: 15px 20px;
    border: 1px solid var(--border);
    border-radius: 8px;
    ...
    gap: 20px; /* FIXED: Add gap for proper spacing */
}

/* First-time section stats bar has different border styling */
.first-time-section .stats-bar {
    background: var(--bg-dark);
...
@media (max-width: 640px) {
    ...
    /* FIXED: Better mobile stats bar with proper spacing */
    .stats-bar, .main-stats-bar {
        flex-direction: column;
        gap: 12px; /* Increased gap for mobile stacking */
        text-align: center;
        padding: 20px;
    }
